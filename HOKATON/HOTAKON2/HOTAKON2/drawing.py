...
#--------EXAMPLE-------------
    ...
    elem = rg.Element(cord1, "Р", [[rg.Element(cord2, 'HO', [[rg.Element(cord5, 'HO', []), 1], [rg.Element(cord6, 'HP', []), 2]]), 3], [rg.Element(cord5, 'HO', []), 2], [rg.Element(cord3, 'CN', [[rg.Element(cord5, 'HO', []), 2]]), 2], [rg.Element(cord4, 'NH', [[rg.Element(cord5, 'HO', []), 2], [rg.Element(cord3, 'CN', []), 2]]), 2]])
#----------------------------
    build_image(elem)
    img.show()
